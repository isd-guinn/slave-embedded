...
void setup() {
  ...
  Serial.begin(115200);
  ImuSerial.begin(115200, SERIAL_8N1, 42, 41); //ISD Dev board Serial2
...
static void CmdProcess(void)
{
	switch(s_cCmd)
	{
		...
		case 'B':	if(WitSetUartBaud(WIT_BAUD_115200) != WIT_HAL_OK) Serial.print("\r\nSet Baud Error\r\n");
              ...
              { 
                ImuSerial.begin(c_uiBaud[WIT_BAUD_115200], SERIAL_8N1, 42, 41);
		...
		case 'b':	if(WitSetUartBaud(WIT_BAUD_9600) != WIT_HAL_OK) Serial.print("\r\nSet Baud Error\r\n");
              ...
              {
                ImuSerial.begin(c_uiBaud[WIT_BAUD_9600], SERIAL_8N1, 42, 41); 
...
static void AutoScanSensor(void)
{
	...
	{
		ImuSerial.begin(c_uiBaud[i], SERIAL_8N1, 42, 41);
    ImuSerial.flush();
		iRetry = 2;
		s_cDataUpdate = 0;
		do
